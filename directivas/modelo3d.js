...
//<div class="mui-panel"><div modelo3d width="400" height="400" fillcontainer="true" scale="1.0" material-type="'phong'"></div></div>
define(['js/micodigo', 'node_modules/three/build/three.min'], 
  function (micodigo, THREE) {
  
  micodigo.register.directive('modelo3d', ['$timeout', 
    function ($timeout) {
      return {
        restrict: 'A',
        scope: { 
        ...
        link: {
          pre: function (scope, element, attrs) {
            ...
            // Watches
            // -----------------------------------
            scope.$watch('fillcontainer + width + height', scope.resizeCanvas);
          ...
          post: function (scope, element, attrs) {
            //Se debe ajustar al tamaño de la pantalla
            setTimeout(function(){
